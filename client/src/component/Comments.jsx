...
const Comments = ({ videoDetails, setVideoDetails, loggedIn }) => {
  ...
  const putComment = async () => {
    ...
    try {
      const response = await api.post(`${PUT_COMMENT}/${videoId}`, {
        text: commentText,
      });
    ...
    <>
              ...
              {comments.map((comment, index) => {
                return (
                  <div
                    ...
                    key={comment?._id}
                    ref={
                      index === comments.length - 1 ? lastCommentRefBig : null
                    }
                  >
      ...
      <div className="lg:hidden flex flex-col items-center bg-[#121212]">
        ...
        <div
          ...
          className="bg-[#292828] cursor-pointer w-full mt-1 font-roboto font-semibold rounded-xl min-h-[80px] flex flex-col px-3 py-3"
        >
          ...
          <div className="flex flex-row h-[42px] relative overflow-hidden w-[82vw]">
            {comments[0] ? (
              <>
                ...
                <div className="truncate overflow-hidden  pl-[45px] ">
                  {comments[0]?.commentData}
                </div>
              </>
            ) : (
